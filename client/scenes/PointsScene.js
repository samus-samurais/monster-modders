  ...
  create() {
    ...
    for(let i = 0; i < ids.length; i++){
        ...
        if(ids[i] === this.playerId){
            ...
            this.player = new Player(this, 600, yPosition * 144 + 144, 'zombiesprite', 'PC', this.socket, this.players[ids[i]].username)
            ...
            this.otherPlayers[ids[i]] = new Player(this, 600, yPosition * 144 + 144, 'zombiesprite','NPC', null, this.players[ids[i]].username);
